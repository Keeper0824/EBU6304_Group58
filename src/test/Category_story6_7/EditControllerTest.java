 ...
 * It primarily tests the getNextId method and logic related to editing transactions.
 *
 * @author Wei Chen
 * @version 1.0
 */
class EditControllerTest {
    ...
    /**
     * Tests the functionality of editing a transaction.
     * Currently, this test method only calls the getNextId method. The actual test logic needs to be supplemented based on specific requirements.
     *
     * @throws Exception If reflection invocation or assertion fails.
     */
    @Test
    ...
    /**
     * Tests whether the system is in edit mode.
     * Currently, this test method only calls the getNextId method. The actual test logic needs to be supplemented based on specific requirements.
     *
     * @throws Exception If reflection invocation or assertion fails.
     */
    @Test
    void testIsEdit() throws Exception {
        // Use reflection to call the private getNextId() method
        Method method = AddController.class.getDeclaredMethod("getNextId");
        method.setAccessible(true);
