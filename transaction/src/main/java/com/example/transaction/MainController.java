...
import com.example.transaction.MainApp;
import com.example.transaction.Transaction;
import com.example.transaction.AddController;
...
public class MainController {
    ...
    private void handleAdd(ActionEvent event) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/fxml/add.fxml"));
    ...
    private void openEditWindow(Transaction transaction) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/com/example/fxml/edit.fxml"));
